...
class TrainingModel(models.Model):
    ...
    loss = models.CharField(max_length=100, blank=True, null=True)
...
class SimulationModel(models.Model):
    description = models.CharField(max_length=200, blank=True, null=True )
    date = models.DateTimeField('date created', blank=True, null=True)
    simulation_path = models.CharField(max_length=100, blank=True, null=True)
    analytic_path = models.CharField(max_length=100, blank=True, null=True)
    single_training_path = models.CharField(max_length=100, blank=True, null=True)
    batch_trainin_path = models.CharField(max_length=100, blank=True, null=True)
    sample_count = models.IntegerField(blank=True, null=True)
    file_size = models.IntegerField(blank=True, null=True)
    lights_count = models.IntegerField(blank=True, null=True)
